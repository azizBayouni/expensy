...
export let assets: Asset[] = [
  ...
  { name: 'S&P 500 ETF', value: 150000, type: 'Investment', status: 'active', platform: 'Fidelity', assetType: 'Stock', units: 100, pricePerUnit: 1500, growth: 12.5, estimatedReturnValue: 168750 },
  { name: 'Apple Inc.', value: 100000, type: 'Investment', status: 'active', platform: 'Fidelity', assetType: 'Stock', units: 50, pricePerUnit: 2000, growth: 8.2, estimatedReturnValue: 108200 },
  { name: 'US Treasury Bond', value: 50000, type: 'Investment', status: 'active', platform: 'TreasuryDirect', assetType: 'Bond', units: 50, pricePerUnit: 1000, growth: 4.5, maturityDate: '2034-07-01', estimatedReturnValue: 52250 },
  { name: 'Bitcoin', value: 7500, type: 'Investment', status: 'inactive', platform: 'Coinbase', assetType: 'Crypto', units: 0.1, pricePerUnit: 75000, growth: -5.1, estimatedReturnValue: 7117.5 },
